    ...
    <div className={s.location}>
        ...
        <div className={s.insetMap}>
          <div className={s.map}>
            <GoogleMap
              ...
              link={getMapsUrl(location)}
            />
          </div>
          <p className={s.address}>{location.physicalAddress.address1}</p>
        </div>
      )}
      {organization.phones && (
        <div className={s.inset + " " + s.insetInGroup}>
          <label className={`${s.contactLabel} ${icons.iconPhone} icon-phone`}>
            Call{" "}
          </label>
      ...
      {organization.url && (
        <div className={s.inset + " " + s.insetInGroup}>
          ...
          >
            <label
              className={`${s.contactLabel} ${icons.iconLink} icon-website`}
            >
              Website
            </label>
      ...
      <div className={s.inset + " " + s.insetInGroup}>
        <a href={getMapsUrl(location)} rel="nofollow" target="_blank">
          <label
            className={`${s.directionsLabel} ${icons.iconCompass} icon-compass`}
          >
            Directions
          </label>
        </a>
