(function(e) {
  e.Parse = e.Parse || {}, e.Parse.VERSION = "js1.2.2"
})(this), function() {
  function C(e, t, n) {
  ...
  t.serverURL = "https://api.parse.com", t.initialize = function(e, n) {
    ...
    return u.onload = function() {
      ...
      e && (i && i(e, u), o.resolve(e))
    }, u.onerror = u.ontimeout = function() {
      s && s(u), o.reject(u)
    }, u.onprogress = function() {}, u.open(e, n), u.send(r), o
    ...
    return a.onreadystatechange = function() {
      if (a.readyState === 4) {
        ...
        if (a.status >= 200 && a.status < 300) {
          ...
          e && (i && i(e, a.status, a), o.resolve(e, a.status, a))
        } else s && s(a), o.reject(a)
      }
    }, a.open(e, n, !0), a.setRequestHeader("Content-Type", "text/plain"), a.send(r), o
    ...
    if (e !== "batch" && e !== "classes" && e !== "functions" && e !== "login" && e !== "push" && e !== "requestPasswordReset" && e !== "users") throw "Bad route: '" + e + "'.";
    var u = t.serverURL;
    ...
    return o = o || {}, t._ajax(i, u, f, o.success, o.error)
    ...
    if (n.__type === "GeoPoint") return new t.GeoPoint({
      latitude: n.latitude,
  ...
  }, t._traverse = function(e, n) {
    if (e instanceof t.Object) return t._traverse(e.attributes, n), n(e);
    if (e instanceof t.Relation) return;
    if (t._.isArray(e)) {
      t._.each(e, function(r, i) {
        var s = t._traverse(r, n);
        s && (e[i] = s)
      });
      return
    }
    if (t._.isObject(e)) {
      t._each(e, function(r, i) {
        var s = t._traverse(r, n);
        s && (e[i] = s)
      });
      return
  ...
  t.Events = {
    on: function(e, t, r) {
      ...
      while (s) a = i[s], o = a ? a.tail : {}, o.next = u = {}, o.context = r, o.callback = t, i[s] = {
        tail: u,
        next: a ? a.next : o
      }, s = e.shift();
      return this
  ...
  t.GeoPoint = function(e, r) {
    ...
    var n = function(n) {
        e.success && e.success(new t.GeoPoint({
    ...
    radiansTo: function(e) {
      var t = Math.PI / 180,
        ...
        a = Math.sin(o / 2),
        f = Math.sin(u / 2),
        l = a * a + Math.cos(n) * Math.cos(i) * f * f;
  ...
  t.ACL = function(e) {
    var r = this;
    r.permissionsById = {};
    if (n.isObject(e)) if (e instanceof t.User) r.setReadAccess(e, !0), r.setWriteAccess(e, !0);
    else {
  ...
  t.Op = function() {
    ...
    _mergeWithPrevious: function(e) {
      ...
      if (e instanceof t.Op.Relation) {
        ...
        var r = n.union(n.difference(e.relationsToAdd, this.relationsToRemove), this.relationsToAdd),
          i = n.union(n.difference(e.relationsToRemove, this.relationsToAdd), this.relationsToRemove),
          s = new t.Op.Relation(r, i);
  ...
  t.Promise = function() {
    ...
    _thenRunCallbacks: function(e) {
      ...
      return r = r || {}, this.then(function(e) {
        return r.success && r.success(e), e
      }, function(e) {
        return r.error && (r.model ? r.error(r.model, e) : r.error(e)), t.Promise.error(e)
      })
    },
  ...
  t.Object = function(e, r) {
    ...
    i && (e = n.extend({}, i, e)), r && r.collection && (this.collection = r.collection), this._serverData = {}, this._opSetQueue = [{}], this.attributes = {}, this._hashedJSON = {}, this._escapedAttributes = {}, this.cid = n.uniqueId("c"), this.changed = {}, this._silent = {}, this._pending = {};
    if (!this.set(e, {
      silent: !0
    ...
    _refreshCache: function() {
      ...
      t._each(this.attributes, function(r, i) {
        r instanceof t.Object ? r._refreshCache() : n.isObject(r) && e._resetCacheForKey(i) && e.set(i, new t.Op.Set(r), {
          silent: !0
        })
      })
    },
    ...
    _finishSave: function(e) {
      ...
      t._traverse(this.attributes, function(e) {
        e.id && e._hasData && (r[e.id] = e)
      });
      var i = n.first(this._opSetQueue);
      this._opSetQueue = n.rest(this._opSetQueue), this._applyOpSet(i, this._serverData), this._mergeMagicFields(e);
      var s = this;
      t._each(e, function(e, n) {
        s._serverData[n] = t._decode(n, e);
        var i = t._traverse(s._serverData[n], function(e) {
    ...
    save: function(e, r, i) {
      ...
      return g.length > 0 ? t.Object._deepSaveAsync(this.attributes).then(function() {
      ...
      }, v.error = t.Object._wrapError(v.error, m, v), this._startSave(), this._saving = (this._saving || 0) + 1, this._allPreviousSaves = this._allPreviousSaves || t.Promise.as(), this._allPreviousSaves._continueWith(function() {
        var e = m.id ? "PUT" : "POST",
          n = m._getSaveJSON(),
          r = "classes",
          i = m.className;
        m.className === "_User" && !m.id && (r = "users", i = null);
        var s = t._request(r, i, m.id, e, n, v);
        return v.wait && m.set(a, p), s
      }), this._allPreviousSaves = s, s)
    },
    destroy: function(e) {
      var r = new t.Promise;
      e = e ? n.clone(e) : {};
    ...
    parse: function(e, r, i) {
      ...
      }), s.updatedAt || (s.updatedAt = s.createdAt), r && (this._existed = r !== 201), s
    },
    clone: function() {
    ...
    var n = [];
    return t._traverse(e, function(e) {
      e._refreshCache(), e.dirty() && n.push(e)
    }), n
  }, t.Object._canBeSerializedAsValue = function(e) {
    var r = !0;
    return e instanceof t.Object ? r = !! e.id : n.isArray(e) ? n.each(e, function(e) {
      t.Object._canBeSerializedAsValue(e) || (r = !1)
    }) : n.isObject(e) && t._each(e, function(e) {
      t.Object._canBeSerializedAsValue(e) || (r = !1)
    }), r
  }, t.Object._deepSaveAsync = function(e) {
    var r = n.uniq(t.Object._findUnsavedChildren(e)),
      i = n.uniq(r);
      ...
      return n.each(e, function(e) {
        ...
        return t._request("batch", null, null, "POST", {
          ...
          n.each(e, function(e, t) {
            r[t].success ? e._finishSave(e.parse(r[t].success, i, s)) : (o = o || r[t].error, e._cancelSave())
          });
          if (o) return t.Promise.error(new t.Error(o.code, o.error))
        }).then(function(e) {
          return o.resolve(e), e
        }, function(e) {
          return o.reject(e), t.Promise.error(e)
        })
      })
    }).then(function() {
      return e
  ...
  t.Collection = function(e, t) {
    ...
    add: function(e, r) {
      ...
      this.length += o, s = t._isNullOrUndefined(r.at) ? this.models.length : r.at, this.models.splice.apply(this.models, [s, 0].concat(e)), this.comparator && this.sort({
        silent: !0
      });
  ...
  var r = /^(\S+)\s*(.*)$/,
    i = ["model", "collection", "el", "id", "attributes", "className", "tagName"];
  ...
  t.Query = function(e) {
    ...
    get: function(e, n) {
      var r = this,
        i = n.success ||
      function() {}, s = n.error ||
      function() {}, o = new t.Promise, u = {
        error: function(e) {
          s(null, e), o.reject(e)
        },
        success: function(e) {
          if (e) i(e), o.resolve(e);
          else {
    ...
    collection: function(e, r) {
      return r = r || {}, new t.Collection(e, n.extend(r, {
  ...
  var t = e.Parse,
    ...
    s, o, u = {
      authenticate: function(e) {
        var t = this;
        FB.login(function(n) {
          n.authResponse ? e.success && e.success(t, {
            id: n.authResponse.userID,
            access_token: n.authResponse.accessToken,
            expiration_date: (new Date(n.authResponse.expiresIn * 1e3 + (new Date).getTime())).toJSON()
          }) : e.error && e.error(t, n)
        }, {
          scope: s
        })
      ...
      restoreAuthentication: function(e) {
        if (e) {
          var r = {
            ...
            expiresIn: (t._parseDate(e.expiration_date).getTime() - (new Date).getTime()) / 1e3
          },
            i = n.clone(o);
  ...
  t.History.started = !1, n.extend(t.History.prototype, t.Events, {
    ...
    start: function(e) {
      ...
      var s = this.getFragment(),
        ...
        u = i.exec(navigator.userAgent.toLowerCase()) && (!o || o <= 7);
      ...
      var a = window.location,
        f = a.pathname === this.options.root;
